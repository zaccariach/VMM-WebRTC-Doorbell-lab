...
function add_signaling_handlers(socket) {
  ...
  socket.on('joined', (room) => {
	...
	// DOORBELL LAB : Change for Doorbell lab (Handling ICE instruction part) 
	handle_joined();
  });
...
async function handle_local_icecandidate(event) {
  ...
  // Use pc.localDescription to get the offer SDP. It should contain the ICE   candidates. Send an 'invite' message to the remote peer with the offer SDP.
